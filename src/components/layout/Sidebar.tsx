      ...
      <nav className="flex-1 overflow-y-auto px-3.5 py-3 space-y-4">
        ...
        <div className="space-y-0.5">
          ...
          >
            ...
            <span>{getLocalizedText('WiT365', 'WiT365', 'WiT365')}</span>
          </NavLink>
          <NavLink
            to="/roadmap"
            className={({ isActive }) =>
        ...
        {isAdmin && (
          <div className="space-y-0.5">
            ...
            >
              <UserCog className="h-[19px] w-[19px] shrink-0" />
              <span>{getLocalizedText('Quản lý người dùng', 'Manage users', 'ユーザー管理')}</span>
            </NavLink>
          </div>
        )}
      </nav>
